...
import 'package:kenali_sister/module/assesment/widget/dialog_benar.dart';
import 'package:kenali_sister/module/assesment/widget/dialog_salah.dart';
  ...
  Widget build(context, AssesmentController controller) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: BackButton(
          onPressed: () {
            Get.offAll(DaftarAssesmenPembelajaranView());
          },
        ),
        title: Text(
          "Assesment Komputer",
